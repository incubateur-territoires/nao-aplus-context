...
export function useAnswerViewTracking(answerId: string, enabled: boolean) {
  ...
  const markAsViewedMutation = useMutation(
    trpc.answer.markAnswerAsViewed.mutationOptions(),
  );
  ...
  }, [answerId, enabled, hasBeenMarked, markAsViewedMutation, queryClient]);
