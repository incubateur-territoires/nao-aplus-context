-- Tableau « Délais de prise en charge » de la page /statistiques-2.
--
-- Ajoute à la vue matérialisée analytics.v_report_fact les colonnes de prise en
-- charge (premier passage du signalement au statut IN_TREATMENT, lu dans
-- public."ReportStatusHistory") :
--   - "inTreatmentAt"                 : date du premier passage en traitement
--   - "hasInTreatment"                : le signalement a été pris en charge
--   - "inTreatmentDelayBusinessDays"  : délai création → prise en charge en
--     jours ouvrés FR (même formule que "firstAnswerDelayBusinessDays" :
--     0 = pris en charge le jour même)
--
